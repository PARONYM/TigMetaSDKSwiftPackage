...
@property (readonly) NSArray<TMSDKItem *> *items __attribute__((swift_name("items")));
...
@property (readonly) NSArray<TMSDKVideo *> *videos __attribute__((swift_name("videos")));
- (instancetype)initWithIdentifier:(NSString *)identifier title:(NSString *)title description:(NSString * _Nullable)description thumbnail_url:(NSString *)thumbnail_url group_id:(int32_t)group_id group_name:(NSString *)group_name url:(NSString *)url created:(NSString *)created updated:(NSString *)updated items:(NSArray<TMSDKItem *> *)items custom:(NSString * _Nullable)custom logo_mode:(int32_t)logo_mode logo_image_url:(NSString * _Nullable)logo_image_url logo_link_url:(NSString * _Nullable)logo_link_url ogp_image_url:(NSString * _Nullable)ogp_image_url videos:(NSArray<TMSDKVideo *> *)videos error:(NSString * _Nullable)error __attribute__((swift_name("init(identifier:title:description:thumbnail_url:group_id:group_name:url:created:updated:items:custom:logo_mode:logo_image_url:logo_link_url:ogp_image_url:videos:error:)"))) __attribute__((objc_designated_initializer));
- (TMSDKContent *)doCopyIdentifier:(NSString *)identifier title:(NSString *)title description:(NSString * _Nullable)description thumbnail_url:(NSString *)thumbnail_url group_id:(int32_t)group_id group_name:(NSString *)group_name url:(NSString *)url created:(NSString *)created updated:(NSString *)updated items:(NSArray<TMSDKItem *> *)items custom:(NSString * _Nullable)custom logo_mode:(int32_t)logo_mode logo_image_url:(NSString * _Nullable)logo_image_url logo_link_url:(NSString * _Nullable)logo_link_url ogp_image_url:(NSString * _Nullable)ogp_image_url videos:(NSArray<TMSDKVideo *> *)videos error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(identifier:title:description:thumbnail_url:group_id:group_name:url:created:updated:items:custom:logo_mode:logo_image_url:logo_link_url:ogp_image_url:videos:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) TMSDKDouble * _Nullable price __attribute__((swift_name("price")));
...
- (instancetype)initWithId:(int32_t)id title:(NSString *)title thumbnail_url:(NSString *)thumbnail_url url:(NSString *)url type:(NSString *)type class_type:(NSString *)class_type tap_behavior:(NSString *)tap_behavior open_behavior:(NSString *)open_behavior popup_size:(int32_t)popup_size time:(NSString * _Nullable)time balloon:(NSString * _Nullable)balloon balloon_bg_color:(NSString *)balloon_bg_color balloon_bg_opacity:(int32_t)balloon_bg_opacity balloon_text_color:(NSString *)balloon_text_color balloon_type:(int32_t)balloon_type balloon_size:(int32_t)balloon_size balloon_direction:(int32_t)balloon_direction balloon_font_style:(int32_t)balloon_font_style balloon_font_weight:(int32_t)balloon_font_weight balloon_custom_image_url:(NSString *)balloon_custom_image_url balloon_overflow:(int32_t)balloon_overflow hidden_balloon:(BOOL)hidden_balloon hidden_thumbnail:(BOOL)hidden_thumbnail sku:(NSString *)sku price:(TMSDKDouble * _Nullable)price currency_code:(NSString * _Nullable)currency_code custom:(NSString * _Nullable)custom panel:(TMSDKPanel * _Nullable)panel vm_scripts:(NSString * _Nullable)vm_scripts show_text_with_image:(BOOL)show_text_with_image error:(NSString * _Nullable)error __attribute__((swift_name("init(id:title:thumbnail_url:url:type:class_type:tap_behavior:open_behavior:popup_size:time:balloon:balloon_bg_color:balloon_bg_opacity:balloon_text_color:balloon_type:balloon_size:balloon_direction:balloon_font_style:balloon_font_weight:balloon_custom_image_url:balloon_overflow:hidden_balloon:hidden_thumbnail:sku:price:currency_code:custom:panel:vm_scripts:show_text_with_image:error:)"))) __attribute__((objc_designated_initializer));
- (TMSDKItem *)doCopyId:(int32_t)id title:(NSString *)title thumbnail_url:(NSString *)thumbnail_url url:(NSString *)url type:(NSString *)type class_type:(NSString *)class_type tap_behavior:(NSString *)tap_behavior open_behavior:(NSString *)open_behavior popup_size:(int32_t)popup_size time:(NSString * _Nullable)time balloon:(NSString * _Nullable)balloon balloon_bg_color:(NSString *)balloon_bg_color balloon_bg_opacity:(int32_t)balloon_bg_opacity balloon_text_color:(NSString *)balloon_text_color balloon_type:(int32_t)balloon_type balloon_size:(int32_t)balloon_size balloon_direction:(int32_t)balloon_direction balloon_font_style:(int32_t)balloon_font_style balloon_font_weight:(int32_t)balloon_font_weight balloon_custom_image_url:(NSString *)balloon_custom_image_url balloon_overflow:(int32_t)balloon_overflow hidden_balloon:(BOOL)hidden_balloon hidden_thumbnail:(BOOL)hidden_thumbnail sku:(NSString *)sku price:(TMSDKDouble * _Nullable)price currency_code:(NSString * _Nullable)currency_code custom:(NSString * _Nullable)custom panel:(TMSDKPanel * _Nullable)panel vm_scripts:(NSString * _Nullable)vm_scripts show_text_with_image:(BOOL)show_text_with_image error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(id:title:thumbnail_url:url:type:class_type:tap_behavior:open_behavior:popup_size:time:balloon:balloon_bg_color:balloon_bg_opacity:balloon_text_color:balloon_type:balloon_size:balloon_direction:balloon_font_style:balloon_font_weight:balloon_custom_image_url:balloon_overflow:hidden_balloon:hidden_thumbnail:sku:price:currency_code:custom:panel:vm_scripts:show_text_with_image:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable error __attribute__((swift_name("error")));
@property (readonly) NSArray<TMSDKPoint *> *points __attribute__((swift_name("points")));
- (instancetype)initWithPoints:(NSArray<TMSDKPoint *> *)points error:(NSString * _Nullable)error __attribute__((swift_name("init(points:error:)"))) __attribute__((objc_designated_initializer));
- (TMSDKPoints *)doCopyPoints:(NSArray<TMSDKPoint *> *)points error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(points:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
