...
- (instancetype)initWithTitle:(NSString *)title description:(NSString * _Nullable)description thumbnail_url:(NSString *)thumbnail_url group_id:(int32_t)group_id group_name:(NSString *)group_name url:(NSString *)url created:(NSString *)created updated:(NSString *)updated items:(NSArray<TMSDKItem *> *)items custom:(NSString * _Nullable)custom logo_mode:(int32_t)logo_mode logo_image_url:(NSString * _Nullable)logo_image_url logo_link_url:(NSString * _Nullable)logo_link_url ogp_image_url:(NSString * _Nullable)ogp_image_url videos:(NSArray<TMSDKVideo *> *)videos error:(NSString * _Nullable)error __attribute__((swift_name("init(title:description:thumbnail_url:group_id:group_name:url:created:updated:items:custom:logo_mode:logo_image_url:logo_link_url:ogp_image_url:videos:error:)"))) __attribute__((objc_designated_initializer));
- (TMSDKContent *)doCopyTitle:(NSString *)title description:(NSString * _Nullable)description thumbnail_url:(NSString *)thumbnail_url group_id:(int32_t)group_id group_name:(NSString *)group_name url:(NSString *)url created:(NSString *)created updated:(NSString *)updated items:(NSArray<TMSDKItem *> *)items custom:(NSString * _Nullable)custom logo_mode:(int32_t)logo_mode logo_image_url:(NSString * _Nullable)logo_image_url logo_link_url:(NSString * _Nullable)logo_link_url ogp_image_url:(NSString * _Nullable)ogp_image_url videos:(NSArray<TMSDKVideo *> *)videos error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(title:description:thumbnail_url:group_id:group_name:url:created:updated:items:custom:logo_mode:logo_image_url:logo_link_url:ogp_image_url:videos:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
